...
export default function MediaPage() {
  ...
  const posts = [
    { title: 'One Day to Go: LT26 is Here', excerpt: 'Tomorrow at ExCeL London: See how we\'re moving the goalposts to 24-hour video delivery for L&D. Stand LP10.', category: 'Company News', slug: 'lt26uk-announcement-2026', color: C.teal, videoId: '', videoToken: '', image: '/media/lt26uk-announcement-2026/card.jpg' },
