...
export default function MediaPage() {
  ...
  const posts = [
    { title: 'Textra Video Makes Onstage Top 100', excerpt: 'Officially in the top 5% of 1,600+ global applicants for Onstage S26 Demo Day. We\'re honoured to be recognized as one of the standout companies in the May cohort.', category: 'Company News', slug: 'onstage-top-100-2026', color: C.teal, videoId: '', videoToken: '' },
