...
export default function MediaPage() {
  ...
  const posts = [
    { title: 'Watch Don\'t Read — The Results', excerpt: 'Dan Pearce IRRV, writing in Insight (IRRV), explores how AI-generated explainer videos—including work from Textra.video—can transform Council Tax, benefits and enforcement communication with residents.', category: 'Company News', slug: 'irrv-insight-watch-dont-read', color: C.navy, videoId: '', videoToken: '', image: '/media/irrv-insight-watch-dont-read/card.jpg' },
