...
export default function ARPPartnershipSectionV2() {
      ...
      <div style={{ ...WRAP, width: '100%' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 64 }}>
          ...
          <p style={{ fontSize: 16, color: C.gray600, lineHeight: 1.7, maxWidth: 600, marginLeft: 'auto', marginRight: 'auto', textAlign: 'center' }}>
            Already trusted by 5 councils across the Anglian Revenues Partnership — Breckland, East Suffolk, East Cambridgeshire, Fenland and West Suffolk.
          </p>
        </div>
