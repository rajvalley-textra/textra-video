#!/usr/bin/env node
/**
 * Generate East Cambridgeshire poster with greyed-out video background
 */
...
async function main() {
  // Load video frame (keep colors)
  const videoFrame = await sharp('public/east-cambs-poster-frame.jpg')
...
`;
  ...
  // Composite: greyed video + gradient overlay
  ...
  console.log('✓ Poster with background generated:', result.size, 'bytes');
}
